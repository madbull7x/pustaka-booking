                        ...
                        <form class="user" method="post" action="<?= base_url('autentifikasi/registrasi'); ?>">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0"> 
                                    ...
                                    id="password1" 
                                    name="password1" 
                                    placeholder="Password"> <?= form_error('password1', '<small class="text-danger pl-3">', '</small>'); ?> 
                                </div>

                                <div class="col-sm-6"> <input type="password" class="form-control form-control-user" 
                                id="password2" 
                                name="password2" 
                                placeholder="Ulangi Password"> <?= form_error('password2', '<small class="text-danger pl-3">', '</small>'); ?> 
                                </div>
                            </div> 
