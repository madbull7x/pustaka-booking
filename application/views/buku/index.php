            ...
            <div class="alert alert-danger" role="alert"> 
                ...
                <table class="table table-hover"> 
                    ...
                    <td> 
                        ...
                        . $b['image']; ?>" class="img-fluid img-thumbnail rounded" style="width:100px;" alt="...">
                        </picture> 
                    </td> 
                    <td>
                    <a href="<?= base_url('buku/ubahBuku/') .
                    $b['id']; ?>" class="badge badge-info"><i class="fas fa-edit"></i> Ubah</a>
                    <a href="<?= base_url('buku/hapusbuku/') .
                    $b['id']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' '
                    . $b['judul_buku']; ?> ?');" class="badge badge-danger"><i class="fas fa-
                    trash"></i> Hapus</a>
                    </td> 
                </tr> 
                <?php } ?> 
