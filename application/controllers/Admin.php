...
{ 
    ...
    { 
        parent::__construct(); $this->load->model(['ModelBuku', 'ModelUser', 'ModelBooking']); cek_login(); cek_user(); 
    } 
    ...
    { 
        ...
        $data['buku'] = $this->ModelBuku->getLimitBuku()->result_array(); //mengupdate stok dan dibooking pada tabel buku 
