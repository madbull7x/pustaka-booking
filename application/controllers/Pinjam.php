     ...
     public function __construct() 
     {
        ...
        public function index() 
        {
            ...
            { 
                ...
                $this->ModelPinjam->simpanDetail($id_booking, $no_pinjam); $denda = 
                $this->input->post('denda', TRUE); $this->db->query("update detail_pinjam set denda='$denda'");
            ...
            { 
                ...
                //update stok dan dipinjam pada tabel buku y
